...
import com.ashupandey.buttomnavigation.databinding.FragmentAccountsBinding
import com.ashupandey.buttomnavigation.databinding.FragmentHomeBinding


class FragmentAccounts : Fragment() {
    var _binding: FragmentAccountsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAccountsBinding.inflate(inflater,
            container,
            false)
